...
" scope="application" />
    ...
    <div id="main">
        ...
        <div class="row margin1050">
            <table class="table">
                <tr><th colspan="2" class="tblines2 tbbg1"><h2>${bd.title}</h2></th></tr> <!-- 제목 -->
                <tr class="tbbg2"><td>${bd.userid}</td><td class="text-right">${bd.regdate} / ${bd.thumbs} / ${bd.views}</td></tr> <!-- 작성자, 작성일, 조회수 -->
                <tr><td colspan="2" class="tbbg3 tblines2">${fn:replace(bd.contents, newChar, "<br>")} <!-- bd.contents 에서 newChar 를 찾아서 <br> 태그로 바꿔줌 -->
                </td></tr> <!-- 본문 -->
            </table>
        </div> <!-- 본문글-->
